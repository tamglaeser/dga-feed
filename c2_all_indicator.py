...
def pull():
    ...
    for line in file:
        ...
        if decoded_line[0] != '#':
            ...
            each = [domain, ip, ns_host, ns_ip, description, manpage]  # array for each line
...
# find malware : see who is asking any of those ns ips for that specific C&C domain -- could be malware
